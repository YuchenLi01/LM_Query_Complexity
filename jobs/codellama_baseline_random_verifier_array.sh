#!/bin/bash
#SBATCH --job-name=codellama_err_pred_p0.95_random
#SBATCH --output=codellama_err_pred_p0.95_random_%A_seed%a.out
#SBATCH --error=codellama_err_pred_p0.95_random_%A_seed%a.err
