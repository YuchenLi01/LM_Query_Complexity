#!/bin/bash
#SBATCH --job-name=codellama_err_pred_p0.95_layer27_noargmax
#SBATCH --output=codellama_err_pred_p0.95_layer27_noargmax_%A_seed%a.out
#SBATCH --error=codellama_err_pred_p0.95_layer27_noargmax_%A_seed%a.err
...
do
    python src/main_run_codellama.py \
      ...
      generation_configs.redo_backtrack_with_argmax=False \
